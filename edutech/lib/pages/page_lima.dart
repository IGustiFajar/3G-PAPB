            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      Image(image: AssetImage('images/Iconcentang.png')),
                      SizedBox(
                          width: 10
                      ),
                      Text(
                ...
                children: <Widget>[
                  Container(
                    child: Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        Image(image: AssetImage('images/Groupsertif2.png')),
                        SizedBox(
                            width: 10
                        ),
                        Text(
                          'Dapatkan sertifikat kelulusan kelas! ',
                          style: TextStyle(fontSize: 12, fontFamily: 'InterSemiBold', color: Colors.red),
                        ),
                      ],
                    ),
                    height: 60,
