...
import 'package:edutech/pages/page_lima.dart';
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    child: Container(
                      child: Text(
                        'UI/UX',
                        style: TextStyle(fontSize: 16, fontFamily: 'InterSemiBold', color: Colors.green),
                      ),
                      height: 30,
                      width: 75,
                      alignment: Alignment.center,
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    'UI/UX Course',
                                    style: TextStyle(fontSize: 12, fontFamily: 'InterSemiBold', color: Colors.blue),
                                  ),
                                  height: 25,
                                  width: 100,
                                  alignment: Alignment.center,
                                        ...
                                        child: Row(
                                          children: <Widget>[
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                image: DecorationImage(
                                                    image: AssetImage('images/Pathstar.png')
                                                ),
                                              ),
                                            ),
                                            SizedBox(
